 ...
 */
class AuthRepositoryImpl constructor(private val authApi: AuthApi):AuthRepository {

    override fun registration(registrationRequest: RegistrationRequest): Flow<NetworkData<Any>> = flowSafe{
    ...
    override fun login(loginRequest: LoginRequest): Flow<NetworkData<LoginResponse.LoginData>> = flowSafe{
    ...
    override suspend fun loginNoFlow(loginRequest: LoginRequest): Response<Wrapper<LoginResponse.LoginData>> = authApi.login(loginRequest)
}